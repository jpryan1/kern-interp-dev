...
#ifndef KERN_INTERP_BOUNDARIES_COW_MESH_H_
#define KERN_INTERP_BOUNDARIES_COW_MESH_H_
...
class CowMesh : public Boundary {
 public:
  ...
  std::unique_ptr<Boundary> clone() const override {
    return std::make_unique<CowMesh>(*this);
  }
};

}  // namespace kern_interp

#endif  // KERN_INTERP_BOUNDARIES_COW_MESH_H_
